...
car_features = extract_features(cars, cspace='HLS', spatial_size=(32, 32),
                        ...
                        hist_bins=32, hist_range=(0, 256), hog_channel=2, datatype='Car')
notcar_features = extract_features(notcars, cspace='HLS', spatial_size=(32, 32),
                        orient=orient, pix_per_cell=pix_per_cell, cell_per_block=cell_per_block,
                        hist_bins=32, hist_range=(0, 256), hog_channel=2, datatype='Noncar')
t2 = time.time()
...
carimage, carhog = extract_features([cars[0]], cspace='HLS', spatial_size=(32, 32),
                        orient=orient, pix_per_cell=pix_per_cell, cell_per_block=cell_per_block,
                        hist_bins=32, hist_range=(0, 256), hog_channel=2, datatype='Car', visualize=True)
notcarimage, notcarhog = extract_features([notcars[0]], cspace='HLS', spatial_size=(32, 32),
                        orient=orient, pix_per_cell=pix_per_cell, cell_per_block=cell_per_block,
                        hist_bins=32, hist_range=(0, 256), hog_channel=2, datatype='Noncar', visualize=True)
