...
carimage, carhog = extract_features([cars[0]], cspace='LUV', spatial_size=(32, 32),
                        orient=orient, pix_per_cell=pix_per_cell, cell_per_block=cell_per_block,
                        hist_bins=32, hist_range=(0, 256), hog_channel=1, datatype='Car', visualize=True)
notcarimage, notcarhog = extract_features([notcars[0]], cspace='LUV', spatial_size=(32, 32),
                        orient=orient, pix_per_cell=pix_per_cell, cell_per_block=cell_per_block,
