...
# going up from 20.0
# going up from 30.0
# going up from 40.0  <-- trying to remove all false positives in test 1 and 4
# going up from 50.0  <-- trying to remove all false positives in test 1 and 4
# going up from 60.0  <-- trying to remove all false positives in test 1 and 4
# going up from 70.0  <-- trying to remove all false positives in test 1 and 4
# going up from 80.0  <-- trying to remove all false positives in test 1 and 4
# going up from 90.0  <-- trying to remove all false positives in test 1 and 4
# going up from 100.0  <-- trying to remove all false positives in test 1 and 4
# going up from 110.0  <-- trying to remove all false positives in test 1 and 4
hthreshold = 120.0

# remove more false negatives
# going down from 8.0
# going down from 7.0
# going down from 6.0  <-- still no edge car, but have car 1 2 3 4 and (5) in test 22
# going down from 5.0  <-- still no edge car, but have car 1 2 3 4 and (5) in test 22
# going down from 4.0  <-- still no edge car, but have car 1 2 3 4 and (5) in test 22
# going down from 3.0  <-- still no edge car, but have car 1 2 3 4 and (5) in test 22
# going down from 2.0  <-- still no edge car, but have car 1 2 3 4 and (5) in test 22
# going down from 1.0  <-- still no edge car, but have car 1 2 3 4 and (5) in test 22
# going down from 0.0  <-- still no edge car, but have car 1 2 3 4 and (5) in test 22
# going down from -1.0  <-- still no edge car, but have car 1 2 3 4 and (5) in test 22
# going up from -5.0  <-- has edge car, car 1 2 3 4 and (5) in test 22
lthreshold = -3.0
