...
# going down from 4.0
# going down from 3.0
# going down from 2.0 <-- no edge car, but can see car 3 4 in test 22
# going down from 1.0 <-- can see edge car, can see car 3 4 in test 22
# going down from 0.5 <-- can see edge car, can see car 3 4 in test 22
# going down from 0.25 <-- can see edge car, can see car 3 4 in test 22
# going down from 0.0 <-- can see edge car, can see car 3 4 in test 22
# going down from -1.0 <-- can see edge car, can see car 3 4 in test 22
# -5.0 <-- can see edge car, can see car 3 4 (5) in test 22
# locked
lthreshold = -5.0
...
for file in images: 
    ...
    for window in windows:
        ...
        wfeatures = chog.extract_features(wimage, cspace='HLS', spatial_size=(32, 32),
                            ...
                            hist_bins=32, hist_range=(0, 256), hog_channel=1)
